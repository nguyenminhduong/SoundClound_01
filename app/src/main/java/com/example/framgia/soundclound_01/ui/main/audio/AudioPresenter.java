...
import static com.example.framgia.soundclound_01.utils.Const.APIConst.APIKey.API_KEY_SOUNDCLOUD;
import static com.example.framgia.soundclound_01.utils.Const.APIConst.Param.PARAM_CLIENT_ID;
import static com.example.framgia.soundclound_01.utils.Const.APIConst.Param.PARAM_GENRE_AUDIO;
import static com.example.framgia.soundclound_01.utils.Const.APIConst.Param.PARAM_KIND_AUDIO;
import static com.example.framgia.soundclound_01.utils.Const.APIConst.Param.PARAM_LIMIT;
import static com.example.framgia.soundclound_01.utils.Const.APIConst.Param.PARAM_OFFSET;
import static com.example.framgia.soundclound_01.utils.Const.APIConst.Param.VALUE_GENRE_POPULAR;
import static com.example.framgia.soundclound_01.utils.Const.APIConst.Param.VALUE_KIND_TOP;
import static com.example.framgia.soundclound_01.utils.Const.APIConst.Param.VALUE_LIMIT;
...
public class AudioPresenter implements AudioContract.Presenter {
    ...
    public void getAudio(int offSet, boolean canLoadMore) {
        ...
        params.put(PARAM_CLIENT_ID, API_KEY_SOUNDCLOUD);
